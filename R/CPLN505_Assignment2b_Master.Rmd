...
*projected change in residences receiving treatment & projected change in residences receiving collection*  
...
mod_vars <- cwns2012 %>% 
  select(res_pop10_dens, res_pop_dens_chng_80_10, proj_change_res_rec_trmt, proj_change_res_rec_collctn, POP10,
         MEDINC09, ResBurden, LogResBurden, LogOfficialNeed, CSS)
