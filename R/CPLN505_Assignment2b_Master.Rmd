...
For our first model, we begin with a selection of all of relevant variables that do not exhibit multi-collinearity.
...
mod1b<-lm (TOTAL_OFFICIAL_NEED ~ POP10*res_pop10_dens + MEDINC09 + MEDINC09*POP10 + proj_change_res_rec_trmt + LogResBurden + CSS, data = cwns2012)
