...
#knitr::opts_knit$set(root.dir = "C:/Users/ctown/Box/PBN_Assignment_2/Data") # for Charlie
knitr::opts_knit$set(root.dir = "/Users/oliveratwood/Box Sync/CPLN 5050 - Planning by Numbers/Assignments/PBN_Assignment_2/Data") # for Oliver
rm(list=ls())
```
...
cwns2012 <- read_csv("cwns2012.csv")
```
...
```{r}
model1<-lm (TOTAL_OFFICIAL_NEED ~ res_pop10_dens, data = cwns2012)
summary(model1)
```
