...
anova(mod1, mod2)
```
Because the AIC is lower for the model without PCTWHITE10, and the Analysis of Variance Table shows an ???increase in F statistic???, we can confidently proceed with model2, dropping PCTWHITE10.
