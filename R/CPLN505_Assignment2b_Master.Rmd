...
* LogResBurden  
* LogOfficialNeed  
* logs of Population variables **still need to make?**  
* logs of Median Income vars **still need to make**  

Calculating Residential Burden:
...
Calculating Log of Residential Burden:

```{r Calculate Log of Residential Burden}
cwns2012 <- cwns2012 %>% 
...
Calculating Log of Total Official Need:
...
* CSS
* 'growing cities'  
* high income **need to make**
* densifying cities?


```{r Dummy variable for growing cities and densifying cities}
...
Final variable list to test with regressions:
* res_pop10_dens
* res_pop_dens_chng_80_10
...
Testing relationships between each of the variables considered above (minus the variables that exhibit strong multi-colinearity with need).
...
* LogResBurden
* CSS  
* 'growing cities' **include once made**
...
**Model 2**
Now we create a new model based on these results.
